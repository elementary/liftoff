...
class AutotoolsPlugin(make.MakePlugin):
    ...
    def env(self, root):
        ...
        env.extend([
            'GI_TYPELIB_PATH=$GI_TYPELIB_PATH:' + self.project.stage_dir + '/usr/lib/' + self.project.arch_triplet + '/girepository-1.0',
            'VAPIDIR=$VAPIDIR:' + self.project.stage_dir + '/usr/share/vala-0.36/vapi'
            ])
        return env
