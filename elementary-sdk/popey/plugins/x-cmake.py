    ...
    def _build_environment(self):
        ...
        env['CMAKE_LIBRARY_PATH'] = '$CMAKE_LIBRARY_PATH:' + ':'.join(
            ['{0}/lib', '{0}/usr/lib', '{0}/lib/{1}',
             '{0}/usr/lib/{1}']).format(
                 self.project.stage_dir, self.project.arch_triplet)
        env['GI_TYPELIB_PATH'] = '$GI_TYPELIB_PATH:/usr/lib/' + self.project.arch_triplet + '/girepository-1.0'
        env['VAPIDIR'] = '$VAPIDIR' + self.project.stage_dir + '/usr/share/vala-0.36/vapi'
        return env
